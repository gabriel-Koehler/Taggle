...
export default function Input(a:InputPorps){
  ...
  <div className={"w-full h-min flex-col "+(a.isError?'text-error [&>div>input]:border-error':'')}>
    ...
    <div className="relative">
      ...
      <input className={"w-full dark:bg-slate-600 bg-gray50 border focus-visible:border-none border-gray200 rounded-md px-2 py-1 focus-visible:outline-[#864EF6] "+(a.iconLeft!=null?'ps-10':'')
